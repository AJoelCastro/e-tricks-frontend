...
const EmptyCartComponent = ({ onReset }: { onReset?: () => void }) => {
  return (
    <Box
      sx={{
        textAlign: 'center',
    ...
    >
      <img
        src="https://tricks-bucket.s3.us-east-2.amazonaws.com/empty_cart.svg"
      ...
      <Link href={'/'}>
        <Typography variant="body1" sx={{ mt: 1, color: '#666', maxWidth: 400 }}>
            Ir a la sección de productos para registrar productos.
        </Typography>
      </Link>      
